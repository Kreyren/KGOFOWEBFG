...
##################################################################################################################################
### THIS IS PATCHED EBUILD FOR https://github.com/Winetricks/winetricks/issues/1158 - Will be removed once merge is finished. ###
################################################################################################################################
...
if [[ ${PV} == "99999999" ]] ; then
	EGIT_REPO_URI="https://github.com/Kreyren/${PN}.git"
	inherit git-r3
	SRC_URI=""
else
	SRC_URI="https://github.com/Kreyren/${PN}/archive/${PV}.tar.gz -> ${P}.tar.gz"
	KEYWORDS="~amd64 ~x86"
fi
...
HOMEPAGE="https://github.com/Kreyren/winetricks https://wiki.winehq.org/Winetricks"
