...
# shellcheck disable=SC2034 # Unused are used by portage
...
src_prepare() {
	epatch "${FILESDIR}/${PNV}-alias.patch"
	epatch "${FILESDIR}/${PNV}-gcc.patch"
	epatch "${FILESDIR}/${PNV}-flex.patch"
	epatch "${FILESDIR}/${PNV}-no-nested-function.patch"
}
